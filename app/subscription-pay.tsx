		...
		<SafeAreaView style={[styles.safe, { backgroundColor: colorScheme === "dark" ? "#000" : "#fff" }]}>
			<View style={styles.container}>
				...
				<View style={[styles.card, { backgroundColor: colorScheme === 'dark' ? "#18191dff" : "#fff" }]}>
					<TouchableOpacity
						activeOpacity={0.9}
						style={[styles.optionRow, plan === 'monthly' ? { backgroundColor: colorScheme === "dark" ? "#131417" : "#f5f8ffff" } : null]}
						onPress={() => setPlan('monthly')}
					>
						<View style={[styles.radio, plan === 'monthly' ? styles.radioActive : null]} />
						<View style={styles.optionTextWrap}>
							<ThemedText style={styles.optionLabel}>Monthly</ThemedText>
						</View>
						<ThemedText style={styles.price}>₽99.00</ThemedText>
					</TouchableOpacity>
				...
				<View style={{ flexDirection: 'column', width: '100%', bottom: 30, position: 'absolute' }}>
					<TouchableOpacity activeOpacity={0.6} style={[styles.subscribeBtnWrapper, {
						backgroundColor: '#002958ff', borderWidth: 1,
					...
					<TouchableOpacity activeOpacity={0.6} style={[styles.cancelBtn, { backgroundColor: colorScheme === "dark" ? "#16181a" : "#f5f8ffff" }]} onPress={() => router.replace('/')}>
